...
public class ContactResource {
  ...
  public Response getContact(@PathParam("id") int id) {
    return Response.ok("{contact.id: " + id + ",name : \"Dummy Name\", phone: \"+0123456789\"}")
        .build();
  }
  ...
  public Response getProto3() throws JsonProcessingException, InvalidProtocolBufferException {
    DogProto.Dog d = DogProto.Dog.newBuilder().setAge(1).setFullName("Capi").build();
  ...
  public Response getGson() throws JsonProcessingException, InvalidProtocolBufferException {
    ...
    sb.append(com.google.protobuf.util.JsonFormat.printer()
        .print(DogProto.Dog.newBuilder().setAge(1).setFullName("Prince").build()));
    sb.append(",");
    sb.append(com.google.protobuf.util.JsonFormat.printer()
  ...
  public Response getGoogleJson() throws JsonProcessingException, InvalidProtocolBufferException {
    List<DogProto.Dog> listDog = new ArrayList<>();
    listDog.add(DogProto.Dog.newBuilder().setAge(1).setFullName("Prince").build());
    listDog.add(DogProto.Dog.newBuilder().setAge(1).setFullName("Pudding ").build());
